...
test_that(".wrap_praat_object maps every remaining class", {
  ...
  wrap_expect_class(FormantGrid(tmin = 0, tmax = 1, number_of_formants = 2), "FormantGrid")
  ...
  wrap_expect_class(FormantTier$from_formant(snd()$to_formant_burg()), "FormantTier")
})
