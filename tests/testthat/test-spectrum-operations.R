...
test_that(
  "spectrum_pass_hann_band modifies the spectrum in place and returns NULL invisibly", {
  spec <- spectrum_of_tone()
...
test_that(
  "spectrum_stop_hann_band modifies the spectrum in place and returns NULL invisibly", {
  spec <- spectrum_of_tone()
