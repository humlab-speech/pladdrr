...
test_that(".check_pitch_range accepts valid ranges and rejects inverted/non-positive", {
  expect_invisible(pladdrr:::.check_pitch_range(75, 600))
  expect_error(pladdrr:::.check_pitch_range(600, 75), class = "pladdrr_input_error")
  expect_error(pladdrr:::.check_pitch_range(-10, 600), class = "pladdrr_input_error")
  expect_error(pladdrr:::.check_pitch_range(75, 75), class = "pladdrr_input_error")
})

test_that(".check_positive_count rejects values below 1", {
  expect_invisible(pladdrr:::.check_positive_count(3, "n_formants"))
  expect_error(pladdrr:::.check_positive_count(0, "n_formants"), class = "pladdrr_input_error")
  expect_error(pladdrr:::.check_positive_count(-1, "n_formants"), class = "pladdrr_input_error")
})

test_that(".check_positive_number rejects non-positive values", {
  expect_invisible(pladdrr:::.check_positive_number(0.01, "time_step"))
  expect_error(pladdrr:::.check_positive_number(0, "x"), class = "pladdrr_input_error")
  expect_error(pladdrr:::.check_positive_number(NA_real_, "x"), class = "pladdrr_input_error")
})
...
test_that(".check_quefrency_range handles autowindow and reversed ranges", {
  ...
  expect_error(pladdrr:::.check_quefrency_range(0.04, 0.001), class = "pladdrr_input_error")
  expect_error(pladdrr:::.check_quefrency_range(-1, 0.04), class = "pladdrr_input_error")
})
...
test_that(".check_trend_fit_method accepts deterministic methods and warns on robust slow", {
  expect_invisible(pladdrr:::.check_trend_fit_method("robust"))
  expect_invisible(pladdrr:::.check_trend_fit_method("least_squares"))
  expect_warning(pladdrr:::.check_trend_fit_method("robust slow"), "robust slow")
})
