...
test_that("voice_report() returns sane, in-range statistics", {
  ...
  expect_gte(report$fraction_unvoiced_frames, 0); expect_lte(report$fraction_unvoiced_frames, 1)
  expect_gte(report$degree_of_voice_breaks, 0); expect_lte(report$degree_of_voice_breaks, 1)
