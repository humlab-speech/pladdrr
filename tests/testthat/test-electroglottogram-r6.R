...
test_that("Electroglottogram constructs and reports basic Sound-like properties", {
  ...
  expect_equal(egg$get_xmin(), 0)
  expect_equal(egg$get_xmax(), 1)
  expect_equal(egg$get_nx(), 16000)
  expect_equal(egg$get_dx(), 1 / 16000)
  expect_equal(egg$get_number_of_samples(), 16000)
