...
.formantpath_methods$get_number_of_candidates <- function(.self) .self$.cpp$get_number_of_candidates()
.formantpath_methods$get_number_of_formant_tracks <- function(.self) .self$.cpp$get_number_of_formant_tracks()
.formantpath_methods$get_ceiling_frequency <- function(.self, candidate) {
  .self$.cpp$get_ceiling_frequency(as.integer(candidate))
}
.formantpath_methods$get_all_ceiling_frequencies <- function(.self) .self$.cpp$get_all_ceiling_frequencies()
...
.formantpath_methods$get_stress_of_candidate <- function(.self, tmin = NULL, tmax = NULL,
...
.formantpath_methods$get_optimal_ceiling <- function(.self, tmin = NULL, tmax = NULL,
                                                      parameters = c(1L, 1L, 1L, 1L, 1L),
                                                      powerf = 1.25) {
  if (is.null(tmin)) tmin <- .self$.cpp$get_xmin()
  if (is.null(tmax)) tmax <- .self$.cpp$get_xmax()
...
# Path manipulation
.formantpath_methods$set_path <- function(.self, tmin = NULL, tmax = NULL, selected_candidate = 1L) {
  if (is.null(tmin)) tmin <- .self$.cpp$get_xmin()
  if (is.null(tmax)) tmax <- .self$.cpp$get_xmax()
...
.formantpath_methods$set_optimal_path <- function(.self, tmin = NULL, tmax = NULL,
                                                   parameters = c(1L, 1L, 1L, 1L, 1L),
                                                   powerf = 1.25) {
  if (is.null(tmin)) tmin <- .self$.cpp$get_xmin()
  if (is.null(tmax)) tmax <- .self$.cpp$get_xmax()
...
FormantPath <- function(sound,
    ...
    if (!inherits(sound, "Sound")) stop("sound must be a Sound object or path to audio file")
