...
extract_formants <- function(sound,
  ...
  .Deprecated(
    ...
    package = "pladdrr",
    msg = "extract_formants() is deprecated and will be removed in v6.0.0. Use the R6 interface: sound$to_formant_burg()"
  )
...
get_formant_at_time <- function(formant, formant_number, time, interpolate = FALSE) {
  ...
  .Deprecated(
    ...
    package = "pladdrr",
    msg = "get_formant_at_time() is deprecated and will be removed in v6.0.0. Use the R6 interface: formant$get_value_at_time(formant_number, time)"
  )
...
get_mean_formant <- function(formant, formant_number, time_range = NULL) {
  ...
  .Deprecated(
    "formant$get_mean()",
    package = "pladdrr",
    msg = "get_mean_formant() is deprecated and will be removed in v6.0.0. Use the R6 interface: formant$get_mean(formant_number, from_time, to_time)"
  )
