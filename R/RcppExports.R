...
amplitude_tier_create_cpp <- function(tmin, tmax) {
    .Call(`_speaker_amplitude_tier_create_cpp`, tmin, tmax)
}

amplitude_tier_add_point_cpp <- function(xptr, time, value) {
    invisible(.Call(`_speaker_amplitude_tier_add_point_cpp`, xptr, time, value))
}

amplitude_tier_get_value_at_time_cpp <- function(xptr, time) {
    .Call(`_speaker_amplitude_tier_get_value_at_time_cpp`, xptr, time)
}

amplitude_tier_get_number_of_points_cpp <- function(xptr) {
    .Call(`_speaker_amplitude_tier_get_number_of_points_cpp`, xptr)
}

amplitude_tier_to_intensity_tier_cpp <- function(xptr, threshold_db) {
    .Call(`_speaker_amplitude_tier_to_intensity_tier_cpp`, xptr, threshold_db)
}

intensity_tier_to_amplitude_tier_cpp <- function(xptr) {
    .Call(`_speaker_intensity_tier_to_amplitude_tier_cpp`, xptr)
}

amplitude_tier_get_shimmer_local_cpp <- function(xptr, shortest_period, longest_period, maximum_amplitude_factor) {
    .Call(`_speaker_amplitude_tier_get_shimmer_local_cpp`, xptr, shortest_period, longest_period, maximum_amplitude_factor)
}

amplitude_tier_get_shimmer_local_db_cpp <- function(xptr, shortest_period, longest_period, maximum_amplitude_factor) {
    .Call(`_speaker_amplitude_tier_get_shimmer_local_db_cpp`, xptr, shortest_period, longest_period, maximum_amplitude_factor)
}

amplitude_tier_get_shimmer_apq3_cpp <- function(xptr, shortest_period, longest_period, maximum_amplitude_factor) {
    .Call(`_speaker_amplitude_tier_get_shimmer_apq3_cpp`, xptr, shortest_period, longest_period, maximum_amplitude_factor)
}

amplitude_tier_get_shimmer_apq5_cpp <- function(xptr, shortest_period, longest_period, maximum_amplitude_factor) {
    .Call(`_speaker_amplitude_tier_get_shimmer_apq5_cpp`, xptr, shortest_period, longest_period, maximum_amplitude_factor)
}

amplitude_tier_get_shimmer_apq11_cpp <- function(xptr, shortest_period, longest_period, maximum_amplitude_factor) {
    .Call(`_speaker_amplitude_tier_get_shimmer_apq11_cpp`, xptr, shortest_period, longest_period, maximum_amplitude_factor)
}

amplitude_tier_get_shimmer_dda_cpp <- function(xptr, shortest_period, longest_period, maximum_amplitude_factor) {
    .Call(`_speaker_amplitude_tier_get_shimmer_dda_cpp`, xptr, shortest_period, longest_period, maximum_amplitude_factor)
}

point_process_sound_to_amplitude_tier_point_cpp <- function(pp_xptr, sound_xptr) {
    .Call(`_speaker_point_process_sound_to_amplitude_tier_point_cpp`, pp_xptr, sound_xptr)
}
...
electroglottogram_create_cpp <- function(xmin, xmax, nx, dx, x1) {
    .Call(`_speaker_electroglottogram_create_cpp`, xmin, xmax, nx, dx, x1)
}

sound_extract_electroglottogram_cpp <- function(xptr, channel, invert) {
    .Call(`_speaker_sound_extract_electroglottogram_cpp`, xptr, channel, invert)
}
...
electroglottogram_to_textgrid_closed_glottis_cpp <- function(xptr, pitch_floor, pitch_ceiling, closing_threshold, peak_threshold) {
    .Call(`_speaker_electroglottogram_to_textgrid_closed_glottis_cpp`, xptr, pitch_floor, pitch_ceiling, closing_threshold, peak_threshold)
}

electroglottogram_to_amplitude_tier_levels_cpp <- function(xptr, pitch_floor, pitch_ceiling, closing_threshold) {
    .Call(`_speaker_electroglottogram_to_amplitude_tier_levels_cpp`, xptr, pitch_floor, pitch_ceiling, closing_threshold)
}

electroglottogram_derivative_cpp <- function(xptr, lowpass_freq, smoothing, peak_amplitude) {
    .Call(`_speaker_electroglottogram_derivative_cpp`, xptr, lowpass_freq, smoothing, peak_amplitude)
}

electroglottogram_first_central_difference_cpp <- function(xptr, peak_amplitude) {
    .Call(`_speaker_electroglottogram_first_central_difference_cpp`, xptr, peak_amplitude)
}

electroglottogram_high_pass_filter_cpp <- function(xptr, from_freq, smoothing) {
    .Call(`_speaker_electroglottogram_high_pass_filter_cpp`, xptr, from_freq, smoothing)
}

electroglottogram_to_sound_cpp <- function(xptr) {
    .Call(`_speaker_electroglottogram_to_sound_cpp`, xptr)
}
