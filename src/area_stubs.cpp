...
// GUI Area class stubs for Praat editor components. Most functions in this file are
// unreachable GUI-editor stubs, but some (preferences/init entry points) do execute
// during Praat initialization — left uninstrumented-by-exclusion, coverage reflects
// actual reachability (baseline measured ~18.9% covered, 17/90 lines genuinely live).
