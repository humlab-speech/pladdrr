...
// Forward declarations needed for PLADDRR_FULL_PRAAT mode
#include "melder/melder.h"
struct structClassInfo;
...
// praat_EEG_init - EEG module not needed for phonetic analysis
void praat_EEG_init () {
    // No-op - EEG module not included
}

// manual_EEG_init - EEG manual pages not needed
struct structManPages;
void manual_EEG_init (structManPages *) {
    // No-op - EEG manual not included
}

// Manual pages stubs - help system not needed in library mode
struct structManPages;
typedef structManPages *ManPages;

void manual_Fon_init (ManPages) {
    // No-op - manual pages not included
}

void manual_Sampling_init (ManPages) {
    // No-op - manual pages not included
}

void manual_sound_init (ManPages) {
    // No-op - manual pages not included
}

void manual_pitch_init (ManPages) {
    // No-op - manual pages not included
}

void manual_spectrum_init (ManPages) {
    // No-op - manual pages not included
}

void manual_formant_init (ManPages) {
    // No-op - manual pages not included
}

void manual_pointProcess_init (ManPages) {
    // No-op - manual pages not included
}

void manual_annotation_init (ManPages) {
    // No-op - manual pages not included
}

void manual_gram_init (structManPages *) {
    // No-op - manual pages not needed in library mode
}

void praat_David_init () {
    // No-op - David module not needed
}

void manual_voice_init (structManPages *) {
...
void praat_MDS_new_init () {
    // No-op - MDS module not needed
}

void praat_picture_open () {
    // No-op - Picture window not supported
}

void manual_Picture_init (structManPages *) {
    // No-op - manual pages not needed
}
...
void manual_commands_init (structManPages *) {
    // No-op - manual pages not needed
}

void manual_formulas_init (structManPages *) {
    // No-op - manual pages not needed
}

void manual_glossary_init (structManPages *) {
    // No-op - glossary help pages not needed
}

void manual_licenses_init (structManPages *) {
    // No-op - licenses help pages not needed
}

void manual_whatsnew_init (structManPages *) {
    // No-op - what's new help pages not needed
}

void praat_KlattGrid_init () {
    // No-op - KlattGrid module not needed
}

void test_FileInMemory_io () {
    // No-op - test function not needed in package
}

void manual_functions_init (structManPages *) {
    // No-op - functions help pages not needed
}

void manual_scripting_init (structManPages *) {
    // No-op
}

void manual_tutorials_init (structManPages *) { /* No-op */ }
void manual_statistics_init (structManPages *) { /* No-op */ }
void manual_phonology_init (structManPages *) { /* No-op */ }
void manual_soundFiles_init (structManPages *) { /* No-op */ }
void manual_audio_init (structManPages *) { /* No-op */ }
void manual_programming_init (structManPages *) { /* No-op */ }
void manual_objects_init (structManPages *) { /* No-op */ }
void manual_exampleSound_init (structManPages *) { /* No-op */ }

void praat_uvafon_LPC_init () { /* No-op */ }
void praat_uvafon_gram_init () { /* No-op */ }
void praat_uvafon_David_init () { /* No-op */ }
void praat_uvafon_Eeg_init () { /* No-op */ }
...
void manual_intro_init (structManPages *) { /* No-op */ }
void manual_types_init (structManPages *) { /* No-op */ }
void manual_operators_init (structManPages *) { /* No-op */ }
void manual_control_init (structManPages *) { /* No-op */ }
void manual_array_init (structManPages *) { /* No-op */ }
void manual_selection_init (structManPages *) { /* No-op */ }

void manual_references_init (structManPages *) { /* No-op */ }
void manual_preferences_init (structManPages *) { /* No-op */ }
void manual_writing_init (structManPages *) { /* No-op */ }
void manual_communication_init (structManPages *) { /* No-op */ }
void manual_reading_init (structManPages *) { /* No-op */ }
void manual_statistics2_init (structManPages *) { /* No-op */ }

void praat_uvafon_stat_init () { /* No-op */ }
void praat_uvafon_multi_init () { /* No-op */ }

// Data conversion stubs
struct structStrings;
struct structDistributions;
void* Strings_to_Distributions (structStrings *) { return nullptr; }
void* Photo_create (int, int) { return nullptr; }
void Movie_paintOneImage (void*, void*, double, double, double, double) { }
void* Spectrum_to_Sound_overlapAdd (void*, int, double) { return nullptr; }

void praat_ExperimentMFC_init () { /* No-op */ }
void praat_uvafon_ExperimentMFC_init () { /* No-op */ }
void praat_Permutation_init () { /* No-op */ }
void praat_SpeechSynthesis_init () { /* No-op */ }
void praat_OTGrammar_init () { /* No-op */ }
void praat_OTMulti_init () { /* No-op */ }
void praat_TimeTier_init () { /* No-op */ }
void praat_TimeFrameSampled_init () { /* No-op */ }

void manual_ExperimentMFC_init (structManPages *) {
    // No-op - ExperimentMFC help pages not needed
}

void praat_TimeTier_query_init (structClassInfo *) {
    // No-op - TimeTier query commands not needed
}

void praat_uvafon_sensors_init () {
    // No-op - Sensor object init not needed
}

void praat_TimeTier_modify_init (structClassInfo *) {
    // No-op - TimeTier modify commands not needed
}

void praat_uvafon_Artsynth_init () {
    // No-op - Articulatory synthesis init not needed
}

void praat_David_generics_new_init () {}

void praat_TimeFunction_query_init (structClassInfo *) {}

void praat_TimeFunction_modify_init (structClassInfo *) {}

void praat_TimeFrameSampled_query_init (structClassInfo *) {}
