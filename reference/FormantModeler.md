...
A `FormantModeler` object with methods for polynomial modeling of
formant trajectories with outlier detection.

## Details

FormantModeler provides polynomial modeling of formant trajectories over
time. It automatically identifies outliers and can find the optimal
formant ceiling for a given sound, making it useful for robust formant
analysis in noisy speech.
