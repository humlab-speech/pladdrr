...
Batch version of to_pitch_cc with full voicing parameters. Avoids O(n)
R→C boundary crossings for VUV analysis workflows. Use this when
processing many sound segments in a loop.
