...
## ----avqi-components, eval=FALSE----------------------------------------------
# # Load example audio
# sound <- Sound$new(system.file("extdata", "voice_sample.wav", package = "pladdrr"))
# 
# # Compute AVQI
# avqi_result <- compute_avqi(sound)
# 
# # Plot AVQI components
# plot_avqi(avqi_result, type = "components")

## ----avqi-waveform, eval=FALSE------------------------------------------------
# # Waveform with AVQI annotation
# plot_avqi(avqi_result, sound, type = "waveform")
# 
# # Spectrogram with formant overlay
# plot_avqi(avqi_result, sound, type = "spectrogram")

## ----avqi-report, eval=FALSE--------------------------------------------------
# # Generate complete diagnostic report
# report_plot <- create_avqi_report_plot(
...
# 
# # Save to file
# ggsave("avqi_report.pdf", report_plot, width = 12, height = 10)

## ----dsi-score, eval=FALSE----------------------------------------------------
# # Compute DSI
# dsi_result <- compute_dsi(sound)
# 
# # Plot DSI score with interpretation
# plot_dsi(dsi_result, type = "score")

## ----dsi-components, eval=FALSE-----------------------------------------------
# # Component visualization
# plot_dsi(dsi_result, type = "components")

## ----dsi-contours, eval=FALSE-------------------------------------------------
# # Pitch and intensity contours
# plot_dsi(dsi_result, type = "contours")

## ----dsi-report, eval=FALSE---------------------------------------------------
# # Multi-panel diagnostic figure
# report_plot <- create_dsi_report_plot(
#   dsi_result = dsi_result,
#   width = 10,
#   height = 8
# )
# 
# ggsave("dsi_report.pdf", report_plot, width = 10, height = 8)
