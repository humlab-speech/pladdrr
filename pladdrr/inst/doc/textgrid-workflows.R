...
# target_label <- "world"
# for (i in 1:n_intervals) {
#   if (tg$get_interval_label(tier_idx, i) == target_label) {
...
## ----efficient_extraction, eval=FALSE-----------------------------------------
...
# 
# for (i in 1:n_phones) {
#   phone_durations$phone[i] <- mfa_tg$get_interval_label(phone_tier, i)
...
#   phone <- tg$get_interval_label(phone_tier, i)
# 
#   if (phone %in% vowels) {
