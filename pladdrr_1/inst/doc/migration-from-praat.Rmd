---
title: "Migration Guide: From Praat Scripts to pladdrr"
author: "Fredrik Nylén"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Migration Guide: From Praat Scripts to pladdrr}
...
This guide helps you translate Praat scripts into R code using pladdrr. The package provides a direct object-oriented interface to Praat's functionality, making translation straightforward and systematic.
...
3. **Integration**: Seamless integration with R's data analysis ecosystem
...
- Class methods: `?Sound`, `?Pitch`, `?Formant`, etc.
- Vignettes: `vignette(package = "pladdrr")`
- GitHub issues: https://github.com/humlab-speech/pladdrr/issues

## Conclusion

The systematic naming conventions in pladdrr make migration from Praat scripts straightforward. Most translations follow a simple pattern: convert Praat commands to lowercase method names with underscores, and use named parameters.

For complex workflows, pladdrr offers additional advantages through R's data manipulation and visualization capabilities.
