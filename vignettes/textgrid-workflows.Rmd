...
```{r visualize_textgrid, eval=FALSE}
library(ggplot2)
...
For further examples (interval duration distributions, label frequency plots, multi-tier layouts), see `vignette("visualization")`.
