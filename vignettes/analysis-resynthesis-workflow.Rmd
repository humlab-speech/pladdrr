...
**Solutions**:
- Always use `klattgrid_create_from_vowel()` (not empty constructor)
...
- `klattgrid_create_from_vowel()` - Safe synthesis
...
5. Synthesize: `kg <- klattgrid_create_from_vowel(...)`
