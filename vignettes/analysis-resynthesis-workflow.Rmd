...
```{r compare-spectrograms, fig.width=8, fig.height=6, eval=FALSE}
...
```{r analyze-synthetic, eval=FALSE}
...
```{r round-trip-viz, fig.width=8, fig.height=4, eval=FALSE}
...
```{r vowel-triangle-synth, eval=FALSE}
...
```{r vowel-triangle-analyze, eval=FALSE}
...
```{r vowel-space-plot, fig.width=8, fig.height=6, eval=FALSE}
...
```{r vowel-relationships, eval=FALSE}
...
```{r morph-viz, fig.width=8, fig.height=5, eval=FALSE}
...
3. Extract: `frm_result <- fp$extract_formant()`
4. Get values: `df <- as.data.frame(frm_result)`
