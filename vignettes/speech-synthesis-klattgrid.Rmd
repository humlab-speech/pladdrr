...
knitr::opts_chunk$set(
  ...
  fig.width = 7,
  fig.height = 5,
  eval = FALSE  # Disable execution to prevent KlattGrid segfault during build
)
```
...
kg$add_formant_point(0, 1, 0.5, 280)   # F1: 730 → 280 Hz
kg$add_formant_point(0, 2, 0.5, 2250)  # F2: 1090 → 2250 Hz
kg$add_formant_point(0, 3, 0.5, 2890)  # F3: 2440 → 2890 Hz
