...
vignette: >
  %\VignetteIndexEntry{Migration Guide: pladdrr v4.0 (data.table)}
...
If your code uses standard data.frame operations, it continues to work without changes.
...
**A:** Yes, ggplot2 works with data.table because it inherits from data.frame.
...
- **Update class checks** - Use `inherits()` instead of `==`
