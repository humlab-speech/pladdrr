...
sound <- Sound$new(duration = 0.5, sampling_frequency = 22050)

# Standard Burg formant extraction
formant_burg <- sound$to_formant_burg(
  time_step = 0.005,                   # 5 ms steps
  max_number_of_formants = 5,          # Track up to F5
  maximum_formant_frequency = 5500,    # Ceiling (Hz)
...
formant_b <- sound$to_formant_burg(max_number_of_formants = 4)
...
formant_male <- sound$to_formant_burg(
  maximum_formant_frequency = 5000    # Men: 5000 Hz
)

# Adult female
formant_female <- sound$to_formant_burg(
  maximum_formant_frequency = 5500    # Women: 5500 Hz
)

# Child
formant_child <- sound$to_formant_burg(
  maximum_formant_frequency = 8000    # Children: 7000-8000 Hz
)
```
...
formant_2 <- sound$to_formant_burg(max_number_of_formants = 2)

# Standard (F1-F5)
formant_5 <- sound$to_formant_burg(max_number_of_formants = 5)

# Extended (up to F7, slower)
formant_7 <- sound$to_formant_burg(
  max_number_of_formants = 7,
  maximum_formant_frequency = 7000
)
```
...
formant <- sound$to_formant_burg(maximum_formant_frequency = 4500)
```
...
formant <- sound$to_formant_burg(maximum_formant_frequency = 4800)
```
...
sound <- Sound$new(duration = 0.3, sampling_frequency = 22050)
