---
title: "Visualization with pladdrr"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Visualization with pladdrr}
...
The `pladdrr` package provides comprehensive visualization capabilities using R's `ggplot2` graphics system. This approach offers several advantages over Praat's native Picture window:
...
The Acoustic Voice Quality Index (AVQI) is a multivariate measure of voice quality. The `pladdrr` package provides several visualization options for AVQI analysis.
...
The `pladdrr` package provides a comprehensive suite of visualization functions leveraging R's `ggplot2` ecosystem. Key advantages include:
