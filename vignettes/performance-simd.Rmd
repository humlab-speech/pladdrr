...
- **SIMD**: Process several samples simultaneously (
  the exact count depends on the CPU and instruction set)
...
- Optimized BLAS/LAPACK (Intel MKL,
  OpenBLAS) affects R's own linear algebra, separately from pladdrr's SIMD kernels
