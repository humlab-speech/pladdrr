...
This vignette demonstrates a complete vowel acoustics research workflow using the **pladdrr** package. Topics covered:
...
The **pladdrr** package provides a complete vowel acoustics pipeline:
