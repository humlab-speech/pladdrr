---
title: "Getting Started with pladdrr: Phonetic Analysis in R"
author: "pladdrr Package Authors"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with pladdrr: Phonetic Analysis in R}
...
The `pladdrr` package provides direct access to Praat's phonetic analysis capabilities from R, without requiring Python. It implements core phonetic analysis objects (Sound, Pitch, Formant, Intensity) with a modern R6 object-oriented interface that follows Praat's conventions.
...
The `pladdrr` package provides comprehensive ggplot2-based visualization functions for all analysis types. For detailed examples of creating publication-quality plots, see `vignette("visualization")`, which covers:
...
The `pladdrr` package provides a comprehensive toolkit for phonetic analysis in R, with:
