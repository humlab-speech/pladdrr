...
The `speaker` package provides comprehensive plotting functions for all analysis types. For detailed visualization examples including vowel spaces, formant trajectories, pitch/intensity contours, spectrograms, and voice quality reports, see `vignette("visualization")`.
