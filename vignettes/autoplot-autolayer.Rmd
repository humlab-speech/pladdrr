...
pladdrr provides `autoplot()` and `autolayer()` methods following the ggplot2 convention for visualizing acoustic data.
...
Each Praat object type has an `autoplot()` method that creates an appropriate visualization.
