...
pladdrr provides `autoplot()` and `autolayer()` methods following the ggplot2 convention for creating composable, publication-quality visualizations of acoustic data.
...
This pattern enables flexible multi-object visualizations:
...
The real power comes from combining objects using `autolayer()`.
