...
```{r standard-vs-path, fig.width=8, fig.height=4, error=TRUE}
# Load example audio
...
if (!is.null(formant_standard) && !is.null(formant_path)) {
  ...
  cat("Note: Formant extraction requires valid audio input.\n")
  cat("This vignette uses synthetic examples for demonstration.\n")
}
```
...
- Praat manual: [FormantPath](https://www.fon.hum.uva.nl/praat/manual/FormantPath.html)
