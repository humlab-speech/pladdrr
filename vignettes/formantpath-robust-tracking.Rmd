...
Unlike standard formant extraction (
  `to_formant_burg(
    )`), FormantPath generates multiple candidate formant tracks with different ceiling frequencies, then uses statistical criteria to select the best path frame-by-frame.
...
- **Too low** (e.g.,
  5000 Hz for female speaker): Misses F3, tracks harmonics as formants
- **Too high** (e.g.,
  6500 Hz for male speaker): Detects spurious formants, poor F1/F2 accuracy
...
- Weenink, D. (
  2015). "Improved formant frequency measurements of short segments"
