...
FormantPath fits `num_candidates` formant tracks per call instead of one, so
expect its cost to scale roughly with the number of candidates requested.
...
1. **Don't use FormantPath for all analyses** - use the standard method when the speaker's formant range is already known
